...
if __name__ == '__main__':
    ...
    datapath = os.path.join(modpath, 'C:\\Users\\Joseph\\Documents\\ETHUSD_backtraderFAIL.csv')
    ...
    # Run over everything
    cerebro.run()
    #_thread.start_new_thread(cerebro.run())
    # Print out the final result
    print('Final Portfolio Value: %.2f' % cerebro.broker.getvalue())

    # Plot the result
    #_thread.start_new_thread(cerebro.plot())
    cerebro.plot()
